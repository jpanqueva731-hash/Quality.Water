...
st.set_page_config(
    page_title="Dashboard IRCA Histórico",
    page_icon="💧",
    layout="wide",
...
if df.empty:
    ...
    if df_filtered.empty:
        ...
        with row1_col1:
            ...
            # Derretir el DataFrame para que plotly pueda graficar varias líneas más fácil
            ...
            fig_trend.update_xaxes(type='category') # Asegurar que los años luzcan como categorías
        ...
        with row1_col2:
            ...
            # Asignar colores lógicos comunes en IRCA
            color_map = {
        ...
        with row2_col1:
            st.subheader("Top 10 Municipios con Mayor IRCA General (del periodo seleccionado)")
            # Promediar el IRCA histórico por municipio
        ...
        with row2_col2:
            ...
            # Filtrar filas donde tengamos ambos valores numéricos
        ...
        # Botón para descargar datos crudos
